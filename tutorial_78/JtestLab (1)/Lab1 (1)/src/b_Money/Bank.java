...
public class Bank {
	...
	public void openAccount(String accountid) throws AccountExistsException {
		if (accountlist.containsKey(accountid)) {
			...
			// .get replaced by .put because of error in testOpenAccount method in BankTest
		}
	}
	...
	public void deposit(String accountid, Money money) throws AccountDoesNotExistException {
		if (!accountlist.containsKey(accountid)) { //! added before accountlist because of error in testDeposit method in BankTest class
	...
	public void withdraw(String accountid, Money money) throws AccountDoesNotExistException {
		if (!accountlist.containsKey(accountid)) {
			...
			Account account = accountlist.get(accountid);
			account.withdraw(money);//.deposit replaced by .withdraw because of error in testWithdraw method in BankTest class
		}
	}
	...
	public void transfer(String fromaccount, String toaccount, Money amount) throws AccountDoesNotExistException {
		...
		//third argument "fromaccount" was replaced by "toaccount" because of error in testTransfer method in BankTest class
	}
